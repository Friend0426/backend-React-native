...
router.get('/results', (req, res) => {
    // Select data from the "polling station" table
    const query = 'SELECT * FROM pscode';
  
    dbConn.query(query, (error, results) => {
      if (error) {
        console.error('Error selecting data from the table:', error);
...
// add a new user
router.post('/add_store', function(req, res, next) {    
